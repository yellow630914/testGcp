  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="testGcpApp.department.home.createOrEditLabel"
          data-cy="DepartmentCreateUpdateHeading"
          v-text="t$('testGcpApp.department.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testGcpApp.department.departmentName')" for="department-departmentName"></label>
            <input
              type="text"
              class="form-control"
              name="departmentName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('testGcpApp.department.location')" for="department-location"></label>
